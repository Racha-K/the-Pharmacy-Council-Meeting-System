...
function DialogRole() {
  return (
    <Dialog>
      <DialogTrigger>
        <button className="w-[528px] bg-purple-500 text-2xl font-semibold text-white py-4 rounded-2xl">
          เข้าสู่ระบบ
        </button>
      ...
      <DialogContent className="max-w-[calc(100vw-48px)] lg:space-y-4 p-4 rounded-3xl">
        ...
        <div className="bg-[#F1F1E8] relative rounded-lg lg:rounded-3xl p-4 max-h-[calc(100vh-20rem)] lg:max-h-full min-h-[400px] overflow-hidden overflow-y-auto">
          <p className="h-full">
            ...
            แต่ไม่รวมถึงข้อมูลของผู้ถึงแก่กรรมโดยเฉพาะ “ข้อมูลส่วนบุคคลที่อ่อนไหว” หมายถึง
            ...
            “ประมวลผล” หมายถึง เก็บรวบรวม ใช้ หรือเปิดเผย “ผู้ควบคุมข้อมูลส่วนบุคคล” หมายถึง
            บุคคลหรือนิติบุคคลที่มีอํานาจในการตัดสินใจเกี่ยวกับการเก็บรวบรวม ใช้
            หรือเปิดเผยข้อมูลส่วนบุคคล “ผู้ประมวลผลข้อมูลส่วนบุคคล” หมายถึง
            ...
            บุคคลหรือนิติบุคคลซึ่งดำเนินการดังกล่าวไม่เป็นผู้ควบคุมข้อมูลส่วนบุคคล สภาเภสัชกรรม
            หมายถึง องค์กรที่เป็น ตัวแทนของผู้ประกอบวิชาชีพเภสัชกรรมในประเทศไทย มี
