...
function StepLogin() {
  return (
    <div className="grid grid-cols-3 gap-4 font-semibold overflow-hidden relative">
      <div className="w-[60%] h-[2.9px] bg-[#E7E6AF] absolute top-6 md:top-9 left-1/2 -translate-x-1/2" />
      <div className="flex flex-col items-center space-x-2 space-y-2 relative">
        <div className="bg-[#F3F2D4] border border-[#E7E6AF] z-10 relative w-[52px] md:w-[72px] aspect-square rounded-full grid place-content-center">
      ...
      <div className="flex flex-col items-center space-x-2 space-y-2">
        <div className="bg-[#F3F2D4]  border border-[#E7E6AF] z-10 w-[52px] md:w-[72px] aspect-square rounded-full grid place-content-center">
