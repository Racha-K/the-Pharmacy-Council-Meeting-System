    ...
    return (
        <Warpper className='space-y-2 lg:!px-[56px]'>
            <div className='flex flex-col gap-4 h-full'>
                ...
                <div className='min-h-max md:grow md:max-h-[700px] lg:max-h-full flex flex-col gap-8'>
                    <div className='bg-[#F1F1E8] max-h-[calc(100vh-320px)] md:grow rounded-xl overflow-y-auto p-4 sm:p-6 '>
                    ...
                    <div className='flex gap-8 sm:gap-16 mb-4 lg:gap-[160px] min-h-max justify-center'>
